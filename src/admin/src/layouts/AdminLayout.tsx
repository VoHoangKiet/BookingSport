...
import { LayoutDashboard, Clock, Users, Trophy } from 'lucide-react'
import "./layout.css";
     ...
     <div className="g-sidenav-show bg-gray-100 flex gap-2">
      ...
      <aside style={{ display: "none" }} className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div className="sidenav-header">
          ...
          <Link className="navbar-brand m-0" to="/owner">
            <img src="/assets/img/logo-ct-dark.png" className="navbar-brand-img h-100" alt="main_logo" />
            <span className="ms-1 font-weight-bold">QuanLy_San</span>
          </Link>
        </div>
        ...
        <div className="navbar-collapse  w-auto " id="sidenav-collapse-main" >
          <ul className="navbar-nav">
            ...
            {/* Sports  */}
            <li className="nav-item">
              <Link className={`nav-link ${isActive('/admin/sports') ? 'active' : ''}`} to="/admin/sports">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {/* TimeSlots  */}
            <li className="nav-item">
              <Link className={`nav-link ${isActive('/admin/configs/time-slots') ? 'active' : ''}`} to="/admin/configs/time-slots">
                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <main className="main-content flex-1 position-relative h-100 border-radius-lg " style={{ marginLeft: "1em" }}>
        {children}
      </main>
    </div>
  );
